...
def main():
   ...
   @media screen and (max-width: 850px) {
    ...
    if dua.button("Peta persebaran RTLH di provinsi Jawa Tengah", icon=":material/public:", use_container_width=True, type="secondary"):
        prompt="buat peta dengan kolom Lat,Long dan Jumlah RTLH di provinsi jawa tengah, dengan data Lat, Long didapatkan dari internet"
                        ...
                        try:
                            ...
                            prompt_grafik = (
                                """
                                    ...
                                    Search the internet to get "Lat column and Long column" from the "kab column",    

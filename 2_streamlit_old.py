...
def ask_gpt4(question, context, model="gpt-4o-mini"):
    ...
    messages = [
        {"role": "system", "content": "Anda adalah asisten AI yang membantu menjawab pertanyaan berdasarkan konteks yang diberikan."},
...
def main():
    ...
    # Path ke FAISS index dan file teks chunk
   ...
   # prompt = st.chat_input()
    ...
    if st.session_state.messages[-1]["role"] != "assistant":
		...
		# Muat potongan teks (chunk) dari file
                ...
                distances, indices = search_faiss_index(prompt, index_path, model="text-embedding-ada-002")
